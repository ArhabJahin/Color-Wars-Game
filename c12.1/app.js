...
function updateBoardSizing() {
  ...
  const topReserve = isShortScreen ? 62 : 104;
  const messageReserve = isShortScreen ? 40 : viewportHeight <= 580 ? 70 : 104;
  const bottomReserve = isShortScreen ? 12 : viewportWidth <= 880 ? 74 : 80;
